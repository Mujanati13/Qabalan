export const ar = {
  ...
  products: {
    ...
    homeSections: {
      ...
      topPicks: 'عرض في قسم التوصيات',
      newArrivals: 'عرض في قسم الوافدين الجدد'
    }
  },
  ...
  orders: {
    ...
    no_delivery_fee: 'غير متوفر',
    orderDateTime: 'تاريخ ووقت الطلب',
    customerName: 'اسم العميل',
    phoneNumber: 'الهاتف',
    email: 'البريد الإلكتروني',
    location: 'الموقع/العنوان',
    contact_location: 'جهة الاتصال والموقع',
    ...
    no_shipping_discount: 'لا يوجد خصم توصيل',
  ...
  payment_link_generation_failed: 'فشل إنشاء رابط الدفع',
  payment_link_missing: 'لم يُرجع الخادم رابط الدفع',
  link_copied_to_clipboard: 'تم نسخ الرابط إلى الحافظة',
  link_for_order: 'رابط للطلب رقم #{orderNumber}',
  open_payment_page: 'فتح صفحة الدفع',
  copy_link: 'نسخ الرابط',
  link_copied: 'تم نسخ الرابط',
  link_copied_for_order: 'تم نسخ الرابط للطلب رقم #{orderNumber}',
  payment_link_instruction: 'شارك هذا الرابط مع العميل لإتمام عملية الدفع:',
  payment_link_note: 'ملاحظة: يظل هذا الرابط صالحًا حتى يتم دفع الطلب أو إلغاؤه.',
