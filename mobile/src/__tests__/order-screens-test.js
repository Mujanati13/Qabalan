...
describe('Order Screens Integration Tests', () => {
  ...
  describe('OrderDetailsScreen Component Tests', () => {
    ...
    it('should format all currency fields safely', async () => {
      ...
      expect(getByTestId('subtotal').textContent).toBe('$22.00');
      expect(getByTestId('delivery-fee').textContent).toBe('$2.50');
      expect(getByTestId('tax-amount').textContent).toBe('$1.00');
      expect(getByTestId('discount-amount').textContent).toBe('$0.00');
      expect(getByTestId('total-amount').textContent).toBe('$25.50');
    });
    ...
    it('should format item prices safely with mixed data types', async () => {
      ...
      expect(item1.querySelector('[data-testid="unit-price"]').textContent).toBe('$10.00');
      expect(item1.querySelector('[data-testid="total-price"]').textContent).toBe('$20.00');

      // Test string price (item 2)
      const item2 = getByTestId('item-2');
      expect(item2.querySelector('[data-testid="unit-price"]').textContent).toBe('$2.00');
      expect(item2.querySelector('[data-testid="total-price"]').textContent).toBe('$2.00');
    });
    ...
    it('should handle null/undefined currency values', async () => {
      ...
      expect(getByTestId('tax-amount').textContent).toBe('$0.00');
      expect(getByTestId('discount-amount').textContent).toBe('$0.00');
    });
