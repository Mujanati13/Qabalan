...
import { MenuOutlined, HomeOutlined, TagsOutlined, ShoppingOutlined, ShoppingCartOutlined, UnorderedListOutlined, PhoneOutlined, MailOutlined } from '@ant-design/icons';
              ...
              <Space direction="vertical" size="small">
                {contactConfig.primaryPhone && (
                  <Text className="text-gray-600">
                    ...
                    <a href={`tel:${contactConfig.primaryPhone}`} className="text-gray-600 hover:text-blue-600">
                      {contactConfig.primaryPhone}
                    </a>
                  </Text>
                )}
                {contactConfig.primaryEmail && (
                  <Text className="text-gray-600">
                    ...
                    <a href={`mailto:${contactConfig.primaryEmail}`} className="text-gray-600 hover:text-blue-600">
                      {contactConfig.primaryEmail}
                    </a>
                  </Text>
                )}
            ...
            <div className="min-w-[220px]">
              ...
              <Space direction="vertical" size="small">
                {contactConfig.socialMedia?.facebook && (
                  <Text className="text-gray-600">
                    <span className="mr-2">📘</span>
                    <a href={contactConfig.socialMedia.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600">
                      Facebook
                    </a>
                  </Text>
                )}
                {contactConfig.socialMedia?.instagram && (
                  <Text className="text-gray-600">
                    <span className="mr-2">📷</span>
                    <a href={contactConfig.socialMedia.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-pink-600">
                      Instagram
                    </a>
                  </Text>
                )}
                {contactConfig.socialMedia?.whatsapp && (
                  <Text className="text-gray-600">
                    <span className="mr-2">💬</span>
                    <a href={`https://wa.me/${contactConfig.socialMedia.whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-green-600">
                      WhatsApp
                    </a>
                  </Text>
                )}
